...
function Items({ _id, description, name, img_url, price, qty,Id }) {
  console.log(qty);
  const {
    state: { cart },
    dispatch,
...
const incprod =async (productinfo) =>{
  ...
  await fetch(`https://devhomoeoback.herokuapp.com/user/${Id}/cart/increase/${productinfo._id}`, {
    method: 'PUT'
...
const dcrprod =async (productinfo) =>{
  ...
  await fetch(`https://devhomoeoback.herokuapp.com/user/${Id}/cart/decrease/${productinfo._id}`, {
    method: 'PUT'
